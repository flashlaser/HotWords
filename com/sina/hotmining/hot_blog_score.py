...
def datas_merge_sort(datas_nouse, datas_use, datas_score):
    ...
    for i in range(0, datas_size):
        ...
        datas.append(data)
    # 对合并后的结构进行排序
    datas.sort(key=lambda x: x[8], reverse=True)
...
if __name__ == '__main__':
    datas_path = '/home/littlebei/program/python/pycharm/HotWords/data/hotming/result/20170504/method1_users_c1-c4_blog_20170504_08.txt'
    ...
    datas_out_path = '/home/littlebei/program/python/pycharm/HotWords/data/hotming/result/20170504/20170504_08.blog_score'
